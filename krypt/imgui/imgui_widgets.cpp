...
bool ImGui::KeyBindButton(const char* label, int* k, const ImVec2& size_arg)
{
    ...
    ImGui::RenderFrame(ImVec2(frame_bb.Min.x - 11.5, frame_bb.Min.y), ImVec2(frame_bb.Max.x + 20, frame_bb.Max.y), ImGui::GetColorU32(ImGuiCol_Button), true, style.FrameRounding);
